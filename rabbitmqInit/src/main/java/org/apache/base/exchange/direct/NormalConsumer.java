...
//        channel.queueBind(queueName,DirectProducer.EXCHANGE_NAME,"warning");
        channel.queueBind(queueName2,DirectProducer.EXCHANGE_NAME,"error");
